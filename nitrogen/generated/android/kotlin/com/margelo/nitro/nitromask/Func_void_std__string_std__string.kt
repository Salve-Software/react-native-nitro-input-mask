...
/**
 * Represents the JavaScript callback `(maskedValue: string, rawValue: string) => void`.
...
fun interface Func_void_std__string_std__string: (String, String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(maskedValue: String, rawValue: String): Unit
}
...
class Func_void_std__string_std__string_cxx: Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(maskedValue: String, rawValue: String): Unit
    = invoke_cxx(maskedValue,rawValue)

  @FastNative
  private external fun invoke_cxx(maskedValue: String, rawValue: String): Unit
}
...
class Func_void_std__string_std__string_java(private val function: (String, String) -> Unit): Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(maskedValue: String, rawValue: String): Unit {
    return this.function(maskedValue, rawValue)
  }
}
