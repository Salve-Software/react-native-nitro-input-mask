///
/// HybridNitroMaskManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.nitromask.views
...
import com.nitromask.*

/**
 * Represents the React Native `ViewManager` for the "NitroMask" Nitro HybridView.
 */
public class HybridNitroMaskManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroMask::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroMask(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroMaskStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridNitroMask? {
    return view.getTag(associated_hybrid_view_tag) as? HybridNitroMask
  }
}
