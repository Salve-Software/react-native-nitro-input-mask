...
/**
 * Wraps a Swift `(_ maskedValue: String, _ rawValue: String) -> Void` as a class.
...
public final class Func_void_std__string_std__string {
  ...
  private let closure: (_ maskedValue: String, _ rawValue: String) -> Void

  public init(_ closure: @escaping (_ maskedValue: String, _ rawValue: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(maskedValue: std.string, rawValue: std.string) -> Void {
    self.closure(String(maskedValue), String(rawValue))
  }
